...
export default function OccupationScatter({ options, selectedOption, onSelect, otherValue, onOtherChange }: Props) {
    ...
    // Determine if "Other" is active (Selected AND has value)
    const isOtherActive = selectedOption === 'その他' && otherValue.length > 0;
        ...
        <View style={styles.container}>
            ...
            <View style={styles.gridContainer}>
                {options.map((opt) => {
                    ...
                    if (opt === 'その他') {
                        const isSelected = selectedOption === 'その他';
                ...
                <View style={styles.modalOverlay}>
                    ...
                    >
                        <Animated.View style={[styles.bottomSheet, { transform: [{ translateY: slideAnim }] }]}>
                            ...
                            {/* Title */}
                            <Text style={styles.modalTitle}>職業を入力してください</Text>
...
const styles = StyleSheet.create({
    ...
    itemBase: {
        width: '48%', // 2 columns
        height: height * 0.085, // Dynamic height (approx 8.5%) to support smaller screens
        flexDirection: 'row',
        alignItems: 'center',
